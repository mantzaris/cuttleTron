...
//drive is distortion
export let distortion_drive: number = 0.0;
const minDrive = 0.0;
const maxDrive = 1.0;

//drive again
export let distortion_gain: number = -20;
const minDriveGain = -20;
const maxDriveGain = 20;

//drive level
export let distortion_level: number = 0;
const minDriveLevel = 0;
const maxDriveLevel = 1;

//drive over toggles more overtones (Boolean)
export let distortion_over: boolean = false;
let distortion_over_shown: number = 0;
const minDriveOver = 0;
const maxDriveOver = 1;

//increasing the distortion effect intensifying
export let distortion_overdrive: number = 1;
const minDriveOverDrive = 1;
const maxDriveOverDrive = 20;

//
export let distortion_trigger: number = 1;
const minTrigger = 0;
const maxTrigger = 1;

//varying pitch like a wave
export let distortion_vibrato: number = 0.01;
...
function updateDistortionParam(event: InputEvent) {
  ...
  document.getElementById(
    "distortionSliderLabel"
  ).innerText = `drive=${distortion_drive}, drive-gain=${distortion_gain}, drive-level=${distortion_level}, drive-over=${distortion_over_shown}, overdrive=${distortion_overdrive}, vibrato=${distortion_vibrato}, trigger=${distortion_trigger}`;
}
